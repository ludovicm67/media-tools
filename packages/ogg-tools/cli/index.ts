...
program.name("ogg-tools").description("A set of tools for working with OGG files");
...
program
  ...
  .requiredOption("-o, --out <output path>", "path to export the fixed OGG chunk to")
  .option("--debug", "show debug information")
  .action(fix);

program
  .command("merge")
  .description("Merge OGG chunks together. The first chunk should be a sane chunk.")
